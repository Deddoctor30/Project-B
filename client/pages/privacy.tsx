        ...
        <div className='container'>
          <div className={styles.privacy}>
            ...
            <ul>
              ...
              <li>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://project B.</li>
            </ul>
            <h2>2. Основные понятия, используемые в Политике</h2>
              <ul>
                ...
                <li>2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://project B.</li>
                ...
                <li>2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://project B.</li>
                ...
                <li>2.10. Пользователь — любой посетитель веб-сайта https://project B.</li>
            ...
            <table>
              <tbody>
                <tr><td>Цель обработки</td><td>предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте</td></tr>
                <tr><td>Персональные данные</td><td>фамилия, имя, отчество, электронный адрес</td></tr>
                <tr><td>Правовые основания</td><td>Федеральный закон «Об информации, информационных технологиях и о защите информации» от 27.07.2006 N 149-ФЗ</td></tr>
                <tr><td>Виды обработки персональных данных</td><td>Сбор, запись, систематизация, накопление, хранение, уничтожение и обезличивание персональных данных</td></tr>
              </tbody>
            </table>
            <h2>7. Файлы cookie</h2>
              <p>7.1 Веб-сайты используют файлы cookie и аналогичные технологии сбора данных для отслеживания пользователей. Эти технологии помогают нам обеспечивать беспроблемный доступ на Веб-сайты и использование услуг сайта, а также используются в аналитических целях. Такая информация не персонифицирована, каждому пользователю присваивается анонимный идентификационный код.</p>
              <p>7.2 Считается, что вы дали согласие на использование файлов cookie, если в соответствующий момент времени их приём разрешён настройками/конфигурацией вашего браузера.</p>
              <p>7.3 Пользователь имеет право в любой момент отключить прием файлов cookies посредством выполнения соответствующих настроек веб-браузера. Отключение cookies может повлечь некорректную работу некоторых элементов сайта project B.</p>
            ...
            <p>9.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора project B@mail.ru с пометкой «Актуализация персональных данных».</p>
            <p>9.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные, если иной срок не предусмотрен договором или действующим законодательством.</p>
            <p>Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора project B@mail.ru с пометкой «Отзыв согласия на обработку персональных данных».</p>
            ...
            <p>13.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты project B@mail.ru.</p>
            ...
            <p>13.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://thismywebsite.com/privacy/.</p>
            <p className={styles.privacy__date}>Вступило в силу 13 июля 2023, 20:49 MSK</p>         
          </div>
        </div>
      </div>
    </>
